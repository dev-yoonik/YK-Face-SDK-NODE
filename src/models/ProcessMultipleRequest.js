...
class ProcessMultipleRequest extends SuperRequest{
     ...
     constructor(data={}){
         ...
         */
        this.modelName = 'process_multiple_request';
    ...
    /**
     * Sets configuration
     * @param {Object} configuration -  configuration Extensible configurations for biometric processing.
     */
    ...
    /**
     * Sets minimum_score
     * @param {String} minimum_score -  minimum score
     */
